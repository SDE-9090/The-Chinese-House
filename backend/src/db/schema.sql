...
CREATE TABLE public.hero_content (
    ...
    title text DEFAULT 'Authentic <span>Chinese Cuisine</span> in Koregaon Park'::text NOT NULL,
    description text DEFAULT 'Traditional flavors. Sizzling wok dishes. Fresh ingredients. Experience the finest culinary journey at The Chinese House.'::text NOT NULL,
    image_url text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE public.location_content (
    ...
    instagram_handle text DEFAULT '@thechinesehouse'::text NOT NULL,
    instagram_url text DEFAULT 'https://www.instagram.com/thechinesehouse'::text NOT NULL,
...
CREATE TABLE IF NOT EXISTS order_items (
    ...
    price_label VARCHAR(100) DEFAULT 'Full',
    image VARCHAR(1024),
    note TEXT,
